...
- [x] 35 automated domain, client, Node HTTP, installed-dependency, push-worker and provider-error checks pass. Paid providers are mocked.
...
- [ ] Complete the approved paid-provider run. Initial reflection and image generation requests returned HTTP 429 from OpenAI. Version 0.7.1 reports the specific documented provider error safely; paid generation readiness remains unverified.
